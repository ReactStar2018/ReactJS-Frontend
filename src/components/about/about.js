...
class About extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            team: [
              {
                icon: require('../../resources/victor.png'),
                name: 'VICTOR MEZRIN',
                role: 'TECHNICAL LEAD',
              ...
              {
                icon: require('../../resources/yazan.png'),
    ...
    render() {
        return <div className="normal">
            <div className="about_normal"  style={{width: this.state.windowWidth <= 1200 ? window.innerWidth*9/10 : 1100}}>
              ...
              <p style={{display: 'inline-block', fontSize: this.state.windowWidth <= 1000 ? 16 : 18}}>Want to contribute?<br/>Email us at <a href="mailto:contribute@jibrel.network"><p style={{display: 'inline-block', fontSize: this.state.windowWidth <= 1000 ? 16 : 18, color: '#4d98ff', cursor: 'pointer'}}>contribute@jibrel.network</p></a></p>
