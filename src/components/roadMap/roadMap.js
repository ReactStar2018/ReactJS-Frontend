        ...
        return <div className="normal">
            <div className="road_normal" style={{width: this.state.windowWidth <= 1200 ? window.innerWidth*9/10 : 1100}}>
              ...
              <table className="table">
                <tr style={{height:10}}>
                  ...
                  <td className="td_3_sub">
                    <div className="text_div_1" style={{fontSize: 12, marginLeft: 10}}>Milestone A - 300 MN JNT</div>
                  </td>
                </tr>
              </table>
              ...
              <table className="table">
                <tr style={{height:10}}>
                  <td className="td_1_sub">
                    <div className="text_div_1" style={{textAlign: 'right', marginRight: 10, fontSize: 12}}>Milestone B - 600 MN JNT</div>
                  </td>
                  <td className="td_2_sub">
                    <div className="line_div"/>
                  </td>
              ...
              <table className="table" style={{marginBottom: 30}}>
                <tr style={{height:10}}>
                  ...
                  <td className="td_3_sub">
                    <div className="text_div_1" style={{fontSize: 12, marginLeft: 10}}>Milestone A - 1200 MN JNT</div>
                  </td>
                </tr>
              </table>
