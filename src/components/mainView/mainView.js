    ...
    renderNavigation() {
        if(this.state.windowWidth <= 1000) {
            return <div className="normal">
                      ...
                      <iframe src="https://player.vimeo.com/video/221562045" width={'90%'} height={window.innerWidth*9/18.3} style={{borderWidth: 0}}></iframe>
                      {this.bankingView()}
                    </div>
            ;
        } else {
            return  <div className="normal">
                      ...
                      <iframe src="https://player.vimeo.com/video/221562045" width={this.state.windowWidth >= 1200 ? 1100 : '90%'} height={this.state.windowWidth >= 1200 ? 620 : window.innerWidth*9/16-70} style={{borderWidth: 0}}></iframe>
                      {this.bankingView()}
                    </div>
            ;
        }
